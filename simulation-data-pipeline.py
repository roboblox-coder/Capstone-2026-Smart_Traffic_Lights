...
# 
#Logic derived from Source 1 (Traffic Data Generator)
...
#Part 2: Data Transformation (Extracting Simulation Parameters)
...
#Part 3: Visual Simulation (With added Debugging)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Simulation for the SUMO")
    parser.add_argument("--web", action="store_true", help="Run a simple web server with '/' route")
